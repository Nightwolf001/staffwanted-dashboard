...
// @mui
import { Box, Card, Button, TextField, IconButton, CardHeader } from '@mui/material';
...
ProfileSendRequest.propTypes = {
  employee: PropTypes.object,
};

export default function ProfileSendRequest({ employee }) {

  const { first_name } = employee.attributes;
  ...
  return (
    ...
    <Card >
      <CardHeader title={`Invite ${first_name} to apply`} />
      <Box sx={{ p: 3 }}>
